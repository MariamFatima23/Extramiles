...
function PlatformCard({ children, text, gap = "gap-[18px]", inner = "w-[242px]" }: PlatformCardProps) {
  return (
    <div className={`mx-auto flex h-[139px] w-full max-w-[300px] flex-col items-center rounded-[12px] bg-white px-[40px] py-[18px] xl:mx-0 xl:w-[300px] ${shadow}`}>
...
export function PlatformCards() {
  return (
    <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:flex xl:items-center xl:justify-between">
      <PlatformCard text="Earn miles on hotels worldwide." inner="h-[110px] w-[242px]">
        <img alt="Booking.com" className="h-[48px] w-[230px] min-w-[50px] object-cover" src={A.booking} />
      </PlatformCard>
      <PlatformCard text={"Earn miles on flights, hotels\n and more."} inner="w-[241px]">
        <img alt="Kayak" className="h-[40px] w-[210px] object-cover" src={A.kayak} />
      </PlatformCard>
      <PlatformCard text="Earn miles on hotels at great prices." gap="gap-[7px]" inner="h-[111px] w-full">
        <img alt="Agoda" className="h-[67px] w-[176px] object-cover" src={A.agoda} />
      </PlatformCard>
